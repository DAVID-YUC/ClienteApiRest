 ...
 * @author mayno
 */
public class EliminarAsignacion extends javax.swing.JFrame {
private Asignacion as1;
    ...
    private void initComponents() {
        ...
        lblTextoPregunta.setText("¿Estas seguro de eliminar 1 Asignación(s)?");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EliminarAsignacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EliminarAsignacion().setVisible(true);
            }
        });
    }
