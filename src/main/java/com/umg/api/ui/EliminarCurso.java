...
public class EliminarCurso extends javax.swing.JFrame {
    ...
    private javax.swing.JLabel lblCurso; // Agregar esta variable

    public EliminarCurso(String nombreCurso) {
        this.nombreCurso = nombreCurso;
        this.cursoService = new CursoServer1();
        initComponents();
        this.setLocationRelativeTo(null);
        mostrarInformacionCurso();
    }

    public void setVentanaCursos(Cursos ventana) {
        this.ventanaCursos = ventana;
    }

    private void mostrarInformacionCurso() {
        lblTextoPregunta.setText("¿Estás seguro de eliminar el curso: " + nombreCurso + "?");
        // Si quieres usar lblCurso en lugar de lblTextoPregunta:
        // lblCurso.setText("Curso a eliminar: " + nombreCurso);
    }
    ...
    private void initComponents() {
        ...
        lblTextoPregunta.setText("¿Estas seguro de eliminar 1 curso(s)?");
...
try {
        // Codificar el nombre del curso para URL
        String nombreCodificado = java.net.URLEncoder.encode(nombreCurso, "UTF-8");

        // URL del backend
        String urlStr = "http://localhost:18/api/curso/nombre/" + nombreCodificado;
        ...
        if (responseCode == 200) {
            ...
            if (ventanaCursos != null) ventanaCursos.cargarDatos();
            this.dispose();
        } else {
            java.io.InputStream errorStream = conn.getErrorStream();
            java.util.Scanner s = new java.util.Scanner(errorStream).useDelimiter("\\A");
            String errorMsg = s.hasNext() ? s.next() : "Error desconocido";
            JOptionPane.showMessageDialog(this, "Error al eliminar curso: " + errorMsg);
        }
 ...
 public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EliminarCurso("NombreCursoEjemplo").setVisible(true);
            }
        });
    }
